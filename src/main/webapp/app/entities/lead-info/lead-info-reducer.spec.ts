...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lead-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEADINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEADINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEADINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEADINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEADINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEADINFO actions', async () => {
      const arg = 42666;
