...
import static com.lexiangmiao.crm.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.lexiangmiao.crm.IntegrationTest;
import com.lexiangmiao.crm.domain.Resource;
import com.lexiangmiao.crm.domain.ResourceAsserts;
import com.lexiangmiao.crm.repository.ResourceRepository;
...
class ResourceResourceIT {
    ...
    void createResource() throws Exception {
        ...
        ResourceAsserts.assertResourceUpdatableFieldsEquals(returnedResource, getPersistedResource(returnedResource));
    }
    ...
    void partialUpdateResourceWithPatch() throws Exception {
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        ResourceAsserts.assertResourceUpdatableFieldsEquals(
            createUpdateProxyForBean(partialUpdatedResource, resource),
            getPersistedResource(resource)
        );
    }
    ...
    void fullUpdateResourceWithPatch() throws Exception {
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        ResourceAsserts.assertResourceUpdatableFieldsEquals(partialUpdatedResource, getPersistedResource(partialUpdatedResource));
    }
    ...
    protected void assertPersistedResourceToMatchAllProperties(Resource expectedResource) {
        ResourceAsserts.assertResourceAllPropertiesEquals(expectedResource, getPersistedResource(expectedResource));
    }

    protected void assertPersistedResourceToMatchUpdatableProperties(Resource expectedResource) {
        ResourceAsserts.assertResourceAllUpdatablePropertiesEquals(expectedResource, getPersistedResource(expectedResource));
    }
}
