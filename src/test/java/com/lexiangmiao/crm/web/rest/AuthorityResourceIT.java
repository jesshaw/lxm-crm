...
import com.lexiangmiao.crm.domain.AuthorityAsserts;
...
class AuthorityResourceIT {
    ...
    void createAuthority() throws Exception {
        ...
        AuthorityAsserts.assertAuthorityUpdatableFieldsEquals(returnedAuthority, getPersistedAuthority(returnedAuthority));
    }
    ...
    protected void assertPersistedAuthorityToMatchAllProperties(Authority expectedAuthority) {
        AuthorityAsserts.assertAuthorityAllPropertiesEquals(expectedAuthority, getPersistedAuthority(expectedAuthority));
    }

    protected void assertPersistedAuthorityToMatchUpdatableProperties(Authority expectedAuthority) {
        AuthorityAsserts.assertAuthorityAllUpdatablePropertiesEquals(expectedAuthority, getPersistedAuthority(expectedAuthority));
    }
}
